...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--country-code",
        default="US",
        help="specifies the account contact country code (e.g. US, GB)",
    )
    parser.add_argument(
        "address",
        help="specifies the account contact address",
    )
    parser.add_argument(
        "city",
        help="specifies the account contact city",
    )
    parser.add_argument(
        "number",
        help="specifies the account contact phone number",
    )
    parser.add_argument(
        "zip",
        help="specifies the account contact zip/postal code",
    )
    parser.add_argument(
        "state",
        nargs="?",
        help="specifies the account contact state or region (e.g. NJ, New Jersey)",
    )
